    ...
    return (
        <div className={"2xl:mx-48 min-h-screen"}>
            <main className={"explore-bg min-h-screen"}>
                    ...
                    <div className={"bg-black/60 lg:h-[32rem] flex flex-col"}>
                        <div className={"flex px-4 lg:px-12 py-12 h-full flex-col items-center justify-center lg:items-start text-white w-full lg:w-8/12"}>
                            <h1 className="text-4xl md:text-5xl font-bold">Making your dreams come true.</h1>
                            <p className={"mt-4 text-lg font-light lg:text-xl leading-8"}>We turn your dream car into a reality by providing you with the opportunity to rent or purchase a driving experience you will never forget. Choose from hundreds of luxurious, fast, and affordable vehicles.</p>
                            <div className={"w-full flex justify-end"}>
                                ...
                                <div className={"w-8/12 md:w-6/12"}>
                                    ...
                                    <div className={"flex w-full justify-between "}>
                                        <button onClick={() => navigate("/category/sale")} className={"btn btn-info px-10 text-xl"}>buy</button>
                                        <button onClick={() => navigate("/category/rent")} className={"btn btn-info px-8 text-xl"}>rent</button>
                                    </div>
                                </div>
                            </div>
                        </div>
