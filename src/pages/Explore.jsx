    ...
    return (
        <div className={"2xl:mx-48 min-h-screen"}>
            <main className={"explore-bg min-h-screen"}>
                    ...
                    <div className={"bg-black/80 h-96 md:h-[32rem] flex flex-col"}>
                        <div className={"flex p-4 lg:p-12 h-full flex-col items-center justify-center lg:items-start text-white w-full lg:w-8/12"}>
                            ...
                            <div className={"w-full flex justify-end"}>
                                ...
                                <div className={"w-8/12 md:w-6/12"}>
                                    <div className={"w-full flex justify-center mt-5 mb-3"}>
                                        <span className={"text-lg font-bold"}>Ready to get behind the wheel?</span>
                                    </div>
