                ...
                <main className={"2xl:px-48"}>
                    ...
                    <div className={"w-full lg:py-6 flex flex-col justify-center lg:px-6"}>
                        {/*<div className={"shadow rounded"}>*/}
                            <div className="stats bg-base-100 lg:bg-neutral-200 flex flex-col lg:flex lg:flex-row shadow rounded">
                                <div className="stat">
                                    <div className={"flex"}>
                                    ...
                                    <div className="stat-desc text-primary">{userData.username}</div>
                                </div>
                                <div className="stat">
                            ...
                            <div className={"stats flex bg-base-100 lg:bg-neutral-200 flex-col lg:flex lg:flex-row  shadow rounded"}>
                                <div className="stat">
